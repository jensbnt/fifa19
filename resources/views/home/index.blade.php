...
@section('content')
    <div class="container">
        <div class="row text-center align-items-center">
            ...
            <div class="col-md-2 mb-3">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Playstation_logo_colour.svg/1280px-Playstation_logo_colour.svg.png"
                     class="card-img-top">
            </div>
        </div>
        <div class="row">
                ...
                <form method="GET" action="{{ route('home.index') }}">
                    ...
                    <div class="btn-group btn-group-flex mb-3">
                        <button name="sort" value="m"
                                class="btn {{ !isset($_GET['sort']) || $_GET['sort'] == "m" ? "btn-primary" : "btn-secondary" }}">
                            Games
                        </button>
                        <button name="sort" value="g"
                                class="btn {{ isset($_GET['sort']) && $_GET['sort'] == "g" ? "btn-primary" : "btn-secondary" }}">
                            Goals
                        </button>
                        <button name="sort" value="a"
                                class="btn {{ isset($_GET['sort']) && $_GET['sort'] == "a" ? "btn-primary" : "btn-secondary" }}">
                            Assists
                        </button>
                        <button name="sort" value="c"
                                class="btn {{ isset($_GET['sort']) && $_GET['sort'] == "c" ? "btn-primary" : "btn-secondary" }}">
                            Contributions
                        </button>
                    </div>
                </form>
